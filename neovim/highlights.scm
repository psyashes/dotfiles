; path: /Users/cohiba/.local/share/nvim/plugged/nvim-treesitter/queries/markdown/highlights.scm
...
; user after
(block_quote) @text.todo.unchecked
(fenced_code_block) @original_code_block
((list_item) @text.title.6)
(list_item (list (list_item) @label))
(list_item (list (list_item (list (list_item) @text.title.3))))
